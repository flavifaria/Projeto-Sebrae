...
class Jogador:
    ...
    def mostrar_inventario(self):
        ...
        for i in range(max_rows):
            inventory_item = self.inventario[i] if i < len(self.inventario) else Text("(Vazio)")
    ...
    def exibir_menu_inventario(self):
        ...
        while True:
            ...
            if choice == '1':
                clear()
                utilizable_items = [item for item in self.inventario if item in ["Poção de HP", "Poção de Mana", "Cajado", "Espada Longa", "Capacete", "Escudo", 'Capuz']]
...
|   |
 ...
 '''
    ...
    player1.inventario.append('Capuz')
