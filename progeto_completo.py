...
class Jogador:
            ...
            if escolha == '1':
                ...
                while True:
                    ...
                    if not self.inventario:
                        ...
                        # Create a dictionary to count occurrences and list unique items
                        item_counts = {}
                        for item in self.inventario:
                            item_counts[item] = item_counts.get(item, 0) + 1
                        
                        unique_sorted_items = sorted(item_counts.keys())

                        for i, item in enumerate(unique_sorted_items): 
                    ...
                    try:
                        ...
                        unique_items_for_sale = sorted(list(set(self.inventario))) # This was needed as the previous unique_items was a dict_keys object
                        if 0 <= sell_index < len(unique_items_for_sale):
                            item_to_sell = unique_items_for_sale[sell_index]
        ...
        if item_nome == "Pomada de Regeneração":
            ...
            if "Cajado" in self.inventario:
                if self.equipado["Primeira Mão"] is None:
                    ...
                    self.equipado["Primeira Mão"] = "Cajado"
                    console.print(f"[bold green]Você equipou o Cajado e seu ataque mágico aumentou para {self.atk_mana}![/bold green]")
                else:
                    console.print(f"[bold yellow]Você já tem {self.equipado['Primeira Mão']} equipado. Desequipe-o primeiro para equipar o Cajado.[/bold yellow]")
            else:
            ...
            if "Espada Longa" in self.inventario:
                if self.equipado["Primeira Mão"] is None:
                    ...
                    self.equipado["Primeira Mão"] = "Espada Longa"
                    console.print("[bold green]Você equipou a Espada Longa e seu ataque aumentou em 10![/bold green]")
                else:
                    console.print(f"[bold yellow]Você já tem {self.equipado['Primeira Mão']} equipado. Desequipe-o primeiro para equipar a Espada Longa.[/bold yellow]")
            else:
    ...
    def exibir_menu_inventario(self):
        ...
        while True:
            ...
            if choice == '1':
                clear()
                utilizable_items = [item for item in self.inventario if item in ["Pomada de Regeneração", "Poção de Mana", "Cajado", "Espada Longa", "Capacete", "Escudo", 'Capuz', 'Peitoral']]
